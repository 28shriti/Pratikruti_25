  ...
  return (
    ...
    >
      ...
      <div className="text-center text-white px-4 md:px-8">
        {/* Date */}
        <p className="text-2xl md:text-4xl font-bold text-black mb-16">Tuesday 25<sup>th</sup> February 2025</p>
        ...
        {/* Small Footer Lines */}
        <div className="text-sm md:text-md text-gray-500 mt-4 mb-10">
